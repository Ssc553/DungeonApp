...
namespace DungeonApp
{
    internal class TestHarness
    {
        static void Main(string[] args)
        {
            ...
            Character barb = new Character("Barbarian", 40, 15, 60);
            Console.WriteLine(barb);
            Console.WriteLine();
            Character sorc = new Character("Sorcerer", 60, 5, 40); //{ Life = 20 }; // EXAMPLE
            Console.WriteLine(sorc);
            Console.WriteLine();
            Character rouge = new Character("Rouge", 40, 10, 50);
            Console.WriteLine(rouge);
            Console.WriteLine();
            Character ama = new Character("Amazon", 60, 0, 45);
            Console.WriteLine(ama);
            Console.WriteLine();
            Character asn = new Character("Assassin", 55, 15, 45);
